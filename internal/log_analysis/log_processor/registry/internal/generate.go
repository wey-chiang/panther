...
const exportFuncName = "LogTypes"
const typeNameLogTypesGroup = "Group"
const pkgPathLogTypes = "github.com/panther-labs/panther/internal/log_analysis/log_processor/logtypes"
const pkgNameLogTypes = "logtypes"

func DiscoverLogTypes(patterns ...string) ([]*types.Package, error) {
	cfg := packages.Config{
		// nolint: staticcheck
	...
	for _, pkg := range pkgs {
		...
		if isLogTypesExportFunc(typGroup, obj) {
...
func isLogTypesExportFunc(typGroup *types.Interface, obj types.Object) bool {
	if obj == nil {
		return false
	}
